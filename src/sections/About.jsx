  ...
  return (
    <section className="c-space my-20" id="about">
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                As a developer, I have honed my skills in both frontend and backend development, creating dynamic
        ...
        <BentoTilt className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src="assets/stacks.png" alt="grid-2" className="w-full sm:h-[276px] h-fit object-contain" />
          ...
          <div className="grid-container">
            <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
              <Globe
                ...
                labelsData={[{ lat: 40, lng: -100, text: 'Manila, Philippines ', color: 'white', size: 15 }]}
              />
            </div>
            <div>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">ivanallen64@gmail.com</p>
              </div>
            </div>
          </div>
        </BentoTilt>
